...
import 'package:bsudoku/providers/settings.dart';
...
class SettingsScreen extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return ChangeNotifierProvider<SettingsScreenProvider>(create: (context) => SettingsScreenProvider(),
            child: Consumer<SettingsScreenProvider>(builder: (context, provider, _) {
                return Scaffold(
                    ...
                    appBar: AppBar(elevation: 0.5, centerTitle: true, backgroundColor: GameColors.appBarBackground,
                        title: Text("settings".tr(), style: GameTextStyles.optionsScreenAppBarTitle.copyWith(fontSize: GameSizes.getWidth(0.045))),
                        leading: const BackButton(),
                        actions: [
                            CustomTextButton(text: "done".tr(), onPressed: () => GameRoutes.back(backTimes: 2))
                        ]),
